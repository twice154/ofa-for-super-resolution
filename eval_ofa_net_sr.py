...
args.validation_frequency = 21
args.print_frequency = 21
...
if __name__ == '__main__':
    ...
    model_path = './exp/sr_bn_mse_normal2pixelshuffle/checkpoint/pixelshuffle_depth_stage1.pth.tar'  # 이거도 매번 바꿔줘야한다.
    load_models(run_manager, net, model_path=model_path)
